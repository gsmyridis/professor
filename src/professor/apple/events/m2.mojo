...
Ported from the `darwin-kperf` crate (events/src/m2.rs), which is
...
struct M2Event(Equatable, ImplicitlyCopyable, RegisterPassable, Writable):
    ...
    comptime LdstX64Uop = Self(44)
    comptime LdstXpgUop = Self(45)
    comptime MapDispatchBubble = Self(46)
    comptime MapIntUop = Self(47)
    comptime MapLdstUop = Self(48)
    comptime MapRewind = Self(49)
    comptime MapSimdUop = Self(50)
    comptime MapStall = Self(51)
    comptime MapStallDispatch = Self(52)
    comptime MmuTableWalkData = Self(53)
    comptime MmuTableWalkInstruction = Self(54)
    comptime RetireUop = Self(55)
    comptime ScheduleEmpty = Self(56)
