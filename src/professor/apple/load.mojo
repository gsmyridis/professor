...
struct LibraryHandle(Movable):
    var kperf_handle: OwnedDLHandle
    var kperfdata_handle: OwnedDLHandle
    var kperf: KPerfSymbols
    var kpep: KPEPSymbols

    def __init__(out self) raises:
        self.kperf_handle = OwnedDLHandle(
            "/System/Library/PrivateFrameworks/kperf.framework/kperf"
        )
        self.kperfdata_handle = OwnedDLHandle(
            "/System/Library/PrivateFrameworks/kperfdata.framework/kperfdata"
        )
        self.kperf = KPerfSymbols(self.kperf_handle)
        self.kpep = KPEPSymbols(self.kperfdata_handle)
...
def _get_event(
    db: KPEPDb.Pointer, alias_index: Int, symbols: KPEPSymbols
) -> KPEPEvent.Pointer:
